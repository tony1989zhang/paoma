package com.chssl17.module.plan;
...
import com.chssl17.base.BaseAct;
import com.chssl17.entity.PlanEntity;
...
import com.chssl17.view.ToastManager;
...
public class PlanAct extends BaseAct {
    ...
    @Event(R.id.tv_zhjh)
    private void btnShare(View v)
    {
        WebAct.onNewInstance(this,"http://www.zjt-cp.com/html/whatIsZhuiHaoPlan.html?os=android","什么是追号计划？");
    }
