...
import com.chssl17.Pk10OmitString;
import com.chssl17.www.R;
import com.chssl17.base.BaseListFm;
import com.chssl17.base.BasePageAdapter;
import com.chssl17.entity.HaoMaBean;
import com.chssl17.entity.LaHmBean;
import com.chssl17.entity.NumberBean;
import com.chssl17.entity.Pk10_omit;
...
public class Fm2 extends BaseListFm<String> implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv1:
                m_tv1.setTextColor(getResources().getColor(R.color.title_red));
                m_tv2.setTextColor(getResources().getColor(R.color.white));
                mF2_ll2.setVisibility(View.VISIBLE);
                mIsWeu = true;
                break;
            case R.id.tv2:
                m_tv1.setTextColor(getResources().getColor(R.color.white));
